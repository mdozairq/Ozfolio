                            ...
                            <div className="container-fluid">
                                ...
                                <div className="collapse navbar-collapse" id="navbarSuppoertedContent">
                                    <ul className="navbar-nav ml-auto mb-2 mb-lg-0">
                                        ...
                                        <li className="nav-item">
                                            <NavLink activeClassName='menu_active' exact className="nav-link active" aria-current="page" to="/education">Education</NavLink>
                                        </li>
                                        <li className="nav-item">
                                            <NavLink activeClassName='menu_active' exact className="nav-link active" aria-current="page" to="/project">Project</NavLink>
                                        </li>
                                        <li className="nav-item">
